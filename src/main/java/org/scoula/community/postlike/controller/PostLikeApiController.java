...
public class PostLikeApiController {
    ...
    public ApiResponse<PostLikeToggleResponseDTO> toggleLike(@PathVariable("postId") Long postId) {
    ...
    public ApiResponse<CommentLikeToggleResponseDTO> getMyLikeStatus(@PathVariable Long postId) {
    ...
    public ApiResponse<List<PostListResponseDTO>> getMyLikedPosts() {

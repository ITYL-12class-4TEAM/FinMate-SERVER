...
public interface FavoriteProductMapper {
    ...
    // 특정 회원의 즐겨찾기 목록 조회
    List<FavoriteProductResponse> selectFavoritesByMemberId(@Param("memberId") Long memberId);
    ...
    // 카테고리별 인기 관심상품 조회
    List<FavoriteProductResponse> selectPopularFavorites(@Param("subcategoryId") Long subcategoryId, @Param("days") int days);

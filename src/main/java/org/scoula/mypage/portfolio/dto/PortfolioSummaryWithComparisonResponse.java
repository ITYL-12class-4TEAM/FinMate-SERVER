...
public class PortfolioSummaryWithComparisonResponse {

    @ApiModelProperty(value = "내 포트폴리오 요약 목록")
    private List<PortfolioSummaryResponse> mySummary;

    @ApiModelProperty(value = "비교 통계 요약 정보")
    private PortfolioComparisonResponse comparisonSummary;
}
